...
class AttentionStore(AttentionControl):
    ...
    def between_steps(self):
        ...
        if (self.cur_step) < (self.max_iter_to_alter)*2 and self.cur_step % 2 ==1 and self.indices_to_alter :
...
class AttentionControlEdit(AttentionStore, abc.ABC):
    ...
    def forward(self, attn, is_cross: bool, place_in_unet: str):
        ...
        if (self.cur_step) < (self.max_iter_to_alter)*2 and self.cur_step % 2 ==1:
            ...
            if is_cross and self.cur_step>1 and self.suppression_masks:
                #print("Supress and enhance")
